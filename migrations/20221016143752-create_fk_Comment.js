...
module.exports = {
  ...
  async down (queryInterface, Sequelize) {
     ...
     */
    await queryInterface.removeConstraint("Comments", "fk_Comments_UserId_ref_User_id");
    await queryInterface.removeColumn("Comments", "UserId");
    await queryInterface.removeConstraint("Comments", "fk_Comments_PhotoId_ref_Photo_id");
